...
public class Producer
{
	public static void main(String[] args)
	{
		...
		props.put("bootstrap.servers", "10.0.1.26:9092,10.0.1.26:9093");//该地址是集群的子集，用来探测集群。
		...
		for (int i = 0; i < 10000; i++)
		{
			...
			producer.send(new ProducerRecord<String, String>("foo1", Integer.toString(i), Integer.toString(i)));
		}
		producer.close();
	}
}