...
{
	private static final String ZOOKEEPER = "10.0.1.26:2181";
	//groupName可以随意给，因为对于kafka里的每条消息，每个group都会完整的处理一遍
	private static final String GROUP_NAME = "test_group";
	private static final String TOPIC_NAME = "okline-install-logs-100";
	...
	public static void main(String[] args)
	{
		...
		// create lis t of 4 threads to consume from each of the partitions
